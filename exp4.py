...
#Model quantization, quantized data
#Load data 
digits= load_digits() 
...
quantized_weights= quantize_model(weights_norm, n_bits=3)
quantized_bias= quantize_model(bias_norm, n_bits=3) 
...
#Accuracy 
weights_rec=dequantize_model(quantized_weights, n_bits=3)*(w_max - w_min) + w_min
bias_rec= dequantize_model(quantized_bias, n_bits=3)*(b_max - b_min) + b_min
